...
If you are present inside SJSU campus like library or engineering building you can skip this step.<br>
If you are using other netwrok you need official VPN(cisco anyconnect) to sjsu servers.[Reference](https://www.sjsu.edu/it/services/network/internet-access/vpn.php)
